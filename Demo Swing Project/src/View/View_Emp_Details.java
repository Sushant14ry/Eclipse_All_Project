...
public class View_Emp_Details extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					View_Emp_Details frame = new View_Emp_Details();
	...
	private JLabel getLblNewLabel() {
		if (lblNewLabel == null) {
			lblNewLabel = new JLabel("View Employee Details");
			lblNewLabel.setFont(new Font("Arial Black", Font.BOLD, 22));
			lblNewLabel.setBounds(414, 10, 307, 40);
		}
		return lblNewLabel;
	}
	...
	private JTextField getFnameinput() {
		if (fnameinput == null) {
			...
			fnameinput.setForeground(Color.BLACK);
	...
	private JTextField getLnameinput() {
		if (lnameinput == null) {
			...
			lnameinput.setForeground(Color.BLACK);
	...
	private JTextField getSalaryinput() {
		if (salaryinput == null) {
			...
			salaryinput.setForeground(Color.BLACK);
	...
	private JTextField getZipinput() {
		if (zipinput == null) {
			...
			zipinput.setForeground(Color.BLACK);
