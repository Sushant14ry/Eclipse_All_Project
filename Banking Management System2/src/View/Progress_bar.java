...
public class Progress_bar extends JFrame {
	...
	private JProgressBar progressBar_bank;
	...
	private JPanel getPanel() {
		if (panel == null) {
			...
			panel.add(getProgressBar_bank());
			panel.add(getLblNewLabel_1());
			panel.add(getLblNewLabel());
		}
		return panel;
	}
	private JProgressBar getProgressBar_bank() {
		if (progressBar_bank == null) {
			progressBar_bank = new JProgressBar();
			progressBar_bank.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 14));
			progressBar_bank.setStringPainted(true);
			progressBar_bank.setBounds(47, 164, 287, 35);
		}
		return progressBar_bank;
	}
