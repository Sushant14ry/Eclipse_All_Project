...
//			Diplay_Book();
	...
	private JLabel getLblFatherName_1_1_1_1() {
		if (lblFatherName_1_1_1_1 == null) {
			...
			lblFatherName_1_1_1_1.setBounds(645, 476, 141, 23);
		...
		if (btnIssue == null) {
			...
			btnIssue.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					Model.Issue_Book isbk = new Model.Issue_Book();
					...
					Issue_book ibk = new Issue_book_empl();
					boolean res = ibk.AddIssue_book(isbk);
					
					if(res) {
						JOptionPane.showMessageDialog(null, "Book Issued Successfull");
						setVisible(false);
	...
	private JDateChooser getDateIssue() {
		if (dateIssue == null) {
			...
			dateIssue.setBounds(796, 472, 263, 29);
		}
		return dateIssue;
	}
	...
	private JSeparator getSeparator() {
		if (separator == null) {
			...
			separator.setBounds(505, 43, 202, 17);
		}
		return separator;
	}
}
